...
public class hdcbis162 extends AppCompatActivity {
    
    private common commonAtt;
    private TableLayout layoutCustomCredit;
    private CheckBox chkCustomCredit;
    private Button calculate;
    private Spinner Rmp, Rdsa, Rse, Rcn, Radms, Rca, Read, Rsqa, Rdwdm, Rmad, Rbsit, Ror, Rsdp, Rit;
    private Spinner Cmp, Cdsa, Cse, Ccn, Cadms, Cca, Cead, Csqa, Cdwdm, Cmad, Cbsit, Cor, Csdp, Cit;
    private TextView txtmp, txtdsa, txtse,txtcn, txtadms, txtca, txtead, txtsqa, txtdwdm, txtmad, txtbsit, txtor, txtsdp, txtit;
    ...
    private final float score=(float) 2.0,distinction=(float)3.80;


    @Override
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(hdcbis162.this,MainActivity.class));
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hdcbis162);
        ...
        try {
            ...
            calculate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivity(new Intent(hdcbis162.this, showResult.class).putExtra("GPA", commonAtt.twoPlaces(result)).putExtra("SCORE", score).putExtra("DISTINCTION", distinction));
    ...
    private void onClickTextView(TextView tView, final String subj)throws Exception{
        tView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Snackbar.make(findViewById(R.id.hdcbis162),subj, Snackbar.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void showSubjectNames()throws Exception{
        ...
        onClickTextView(txtcn,"Computer Networks");
    ...
    private void initializeSpinnerCredit()throws Exception{
        ...
        Ccn =(Spinner)findViewById(R.id.spinCreditCN);
